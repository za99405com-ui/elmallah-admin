...
const MainDashboardContent: React.FC = () => {
  ...
  return (
    <div
      dir="rtl"
      className={`min-h-screen w-full flex flex-col font-sans antialiased transition-colors duration-200 selection:bg-cyan-500/30 selection:text-cyan-600 dark:selection:text-cyan-200 ${
        darkMode ? 'dark bg-[#090e1a] text-slate-100' : 'bg-slate-100/90 text-slate-900'
      }`}
    >
